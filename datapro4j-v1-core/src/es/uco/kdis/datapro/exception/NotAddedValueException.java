...
/**
 * This class represents the exception thrown when a value is not added to the dataset.
 * 
 * <p>
 * CONTACT INFO:
 * <ul> 
 ...
 *
 **/
public class NotAddedValueException extends Exception {
	 ...
	 * @param sMessage The exception message to be shown.
     @since 0.1
	 **/
        public NotAddedValueException(String sMessage) {
